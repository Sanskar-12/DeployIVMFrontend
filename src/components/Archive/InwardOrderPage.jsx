...
import MyModal from "../Inward/MyModal";
import { useDispatch, useSelector } from "react-redux";
import moment from "moment"
import {
  changeStatusActions,
  getAllInwardArchivedActions,
} from "../../Actions/inwardActions";
import Loader from "../Loader/Loader";

const InwardOrderPage = () => {
  ...
  const { archivedOrders, loading } = useSelector((state) => state.inward);

  useEffect(() => {
    dispatch(getAllInwardArchivedActions());
  }, [dispatch]);
        ...
        <>
          <div>
            <div>
              ...
              {/* top bar inward */}
              <div>
                <div className="text-[24px]">Inward Archive</div>
                <div className="flex">
                  <Link
                    to="/home"
                  ...
                  <tbody className="bg-white">
                    {archivedOrders?.map((order) => (
                      <tr key={order?._id}>
                        ...
                        <td className="text-md text-center  border-b px-6 py-3">
                        {moment(order?.inwardDate).add(15, 'days').format("DD/MM/YYYY")}
                        </td>
...
export default InwardOrderPage;
