...
import { getAllOrderArchivedActions } from "../../Actions/orderActions";
...
const OrderArchivePage = () => {
  ...
  const { loading, archivedOrders } = useSelector((state) => state.orders);
  ...
  useEffect(() => {
    dispatch(getAllOrderArchivedActions());
  }, [dispatch]);
            ...
            <table className="w-full shadow-md  border-2 rounded-2xl ">
              <thead className="w-full">
                <tr className="border border-solid ">
                  ...
                  <th className="text-md px-6 py-3">Acrhived Date</th>
                </tr>
              </thead>
                ...
                {archivedOrders?.map((order) => (
                  <tr key={order?._id}>
                    <>
                      ...
                      <td className="py-3 border-b px-6 text-center">
                        {moment(order?.verifierApprovedDate)
                          .add(15, "days")
                          .format("DD/MM/YYYY")}
                      </td>
                    </>
